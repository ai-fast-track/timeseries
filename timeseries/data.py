...
__all__ = ['TSData', 'get_ts_items', 'show_timeseries', 'download_unzip_data', 'unzip', 'download_unzip_data_UCR',
           'unzip_data', 'URLs_TS', 'get_UCR_univariate_list', 'get_UCR_multivariate_list']
...
def unzip_data(url, fname=None, dest=None, c_key='data', force_download=False, extract_func=file_extract):
